...
def get_cookie_path():
    """
    Locate cookies. Priority:
    1. Environment Variable (Base64 encoded) - Best for Render/Cloud
    2. Render Secret File (Read-only mount)
    3. Local file
    """
    ...
    # 2. Check if we are on Render and have secrets
